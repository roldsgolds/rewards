...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { company_name: @reward.company_name, company_website: @reward.company_website, email: @reward.email, first_name: @reward.first_name, last_name: @reward.last_name, phone: @reward.phone } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { company_name: @reward.company_name, company_website: @reward.company_website, email: @reward.email, first_name: @reward.first_name, last_name: @reward.last_name, phone: @reward.phone } }
